...
const QuestionNsupport = () => (
    <div className="row" style={{ fontFamily: 'Poppins', padding: '6vw 0 0 0' }}>
        <div className="col-lg-6 row mt-4">
            <div className="col-2" style={{ maxWidth: "4rem" }}><LazyLoadImage effect='blur' src={question} alt="" /></div>
        ...
        <div className="col-lg-6 row mt-4">
            <div className="col-2" style={{ maxWidth: "4rem" }}><LazyLoadImage effect='blur' src={support} alt="" /></div>
            <div className="col-10">
